                  ...
                  <MenuItems
                    ...
                    <div class="py-1">
                      ...
                      <router-link :to="{name: 'payment.payment', params: {id: loan.id}}">
                        <MenuItem v-slot="{ active }">
                          <div class='bg-amber-200 text-gray-700 block px-4 py-2 text-sm'>
                            <div class="flex ">
                              <div>
                              ...
                              <div class="ml-3 text-base">Monthly Deduction</div>
                            </div>
                          </div>
                        </MenuItem>
                      </router-link>
                        ...
                        <MenuItem @click="isOpen = loan" v-slot="{ active }">
                          <a href="#" class='bg-emerald-200 text-gray-700 block px-4 py-2 text-sm'>
                            <div class="flex ">
                              ...
                              <div class="ml-3 text-base">Loan Details</div>
                            </div>
                          </a>
                        </MenuItem>
<!--                      </router-link>-->
                      ...
                      <MenuItem v-slot="{ active }">
                        <button @click="deleteloan(loan.id)" class='bg-red-200 text-gray-900  px-4 py-2 text-sm'>
                          <div class="flex ">
                            <div>
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
