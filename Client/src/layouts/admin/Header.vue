...
<template>
  <div>
    <button @click="toggleSidebar"
            ...
            type="button"
            class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-black-200 dark:text-black dark:hover:bg-gray-700 dark:focus:ring-gray-600">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
           id="default-sidebar"
           class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0 rounded-3xl overflow-y-hidden"
           aria-label="Sidebar">
