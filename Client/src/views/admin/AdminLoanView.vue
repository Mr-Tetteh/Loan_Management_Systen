        ...
        <table class="min-w-full  rounded-3xl shadow divide-y divide-gray-200">
          ...
          <tr v-for="(loan) in  loans" :key="loans.id">
            <td class="px-6 py-4 whitespace-nowrap flex items-center">
              <div>
                <div class="text-sm font-medium text-gray-900">{{ loan.first_name }}       {{ loan.other_names }}     {{ loan.last_name }}</div>
              </div>
            </td>
                    ...
                    <div class="py-1">
                      <router-link :to="{name: 'loan.edit', params: {id: loan.id}}">
                        <MenuItem v-slot="{ active }">
                          <a href="#" class="bg-blue-200 text-gray-700 flex items-center justify-between w-full px-4 py-2 text-sm">
                      ...
                      <router-link :to="{name: 'payment.payment', params: {id: loan.id}}">
                        <MenuItem v-slot="{ active }">
                          <div class="bg-amber-200 text-gray-700 flex items-center justify-between w-full px-4 py-2 text-sm">
                            <div class="flex items-center">
                      ...
                      <MenuItem @click="isOpen = loan" v-slot="{ active }">
                        <a href="#" class="bg-emerald-200 text-gray-700 flex items-center justify-between w-full px-4 py-2 text-sm">
                          <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
                      ...
                      <MenuItem v-slot="{ active }">
                        <button @click="deleteloan(loan.id)" class="bg-red-200 text-gray-900 flex items-center justify-between w-full px-4 py-2 text-sm">
                          <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
