...
const {user, update_user, updated_user, get_user} = useAdminSignup()
          ...
          <div class="border-b border-gray-900/10 pb-12">
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div class="sm:col-span-2">
                ...
                <div class="mt-2">
                  <select v-model="user.user_type" id="country" name="country" autocomplete="country-name"
